...
namespace WindowsFormsApp56
{
    class BusinessRecognition
    {
        ...
        #region Veri Kaydet
        public bool SaveTrainingData(Image face_data, string ogrenciNumara)
        {
            try
            {

                if (this.EskiOgrenciNumarasi != ogrenciNumara)
                    this.i = 0;
                this.EskiOgrenciNumarasi = ogrenciNumara;
                //Random rand = new Random();
                bool file_create = true;
                this.i += 1;
                string facename = "Ogrenci_" + ogrenciNumara + "_" + i.ToString() + ".jpg";
                while (file_create)
                {
                    ...
                    {
                        facename = "Ogrenci_" + ogrenciNumara + "_" + i.ToString() + ".jpg";
                    }
                }
                ...
                if (File.Exists(Dizin + XmlVeriDosyasi))
                {
                    ...
                    name_D.InnerText = ogrenciNumara;
                ...
                else
                {
                    ...
                    using (XmlWriter writer = XmlWriter.Create(FS_Face))
                    {
                        ...
                        writer.WriteElementString("NAME", ogrenciNumara);
